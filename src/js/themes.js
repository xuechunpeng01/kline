...
export class DarkTheme extends Theme {
    ...
    constructor() {
        ...
        this._colors[Theme.Color.Indicator0] = "#74ACFF";
        // this._colors[Theme.Color.Indicator1] = "#f9ee30";
        this._colors[Theme.Color.Indicator1] = "#CAAF80";
        // this._colors[Theme.Color.Indicator2] = "#f600ff";
        this._colors[Theme.Color.Indicator2] = "#CAAF80";
        ...
        this._colors[Theme.Color.TextPositive] = "#56B783";
        // this._colors[Theme.Color.TextNegative] = "#ff6f5e";
        this._colors[Theme.Color.TextNegative] = "#F46F6F";
        ...
        this._colors[Theme.Color.CircleColorFill] = "#F46F6F";
